...
namespace ModTemplate
{
    ...
    {
        public ExampleCommand() : base("examplecommand", "examplecommand")
        {
        }
        ...
        {
            ConsoleWindow3.SendConsoleResponse("An example command from ModTemplate", ConsoleMessageType.SpecialInfo);
            return true;
        }
    }
}